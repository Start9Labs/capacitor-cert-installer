    ...
    private func setupHandlers()
    {
        ...
        localServer["/install"] = { request in
            ...
            case .InstalledConfig:
                return .ok(.html("<h1>Additional instructions:</h1><ol><li>Go to Settings on your iOS device.</li><li>General &rarr; Profile &rarr; Downloaded Profile &rarr; Install</li><li>General &rarr; About &rarr; Certificate Trust Settings &rarr; Enable Full Trust for Root Certificates</li></ol><script>fetch(\"/shutdown\")</script>"))
            case .BackToApp:
